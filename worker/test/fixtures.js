// Test fixtures shaped like real Google Forms receipts — copy of server/test-fixtures.js
// (structure from the user's actual 2026-09 receipts; name, student number and links are fake).
// A receipt lists each question as "Title *", its description, then the answer.

export const receiptBody = ({ tag = 'Iterative Problem Solving', kind = '과제', week = '1주차', weekDescription, extra = '' } = {}) => `Google Forms
...
export const receipt = ({ tag = 'Iterative Problem Solving', kind = '과제', ...bodyOpts } = {}, overrides = {}) => ({
...
export const SELF_FEEDBACK_WEEK_DESCRIPTION = 'Warm-up 기간에는 0주차를, 매주 수업이 끝난 뒤에는 그 주차를, 코스 말미에는\n16주차를 고르세요.';
